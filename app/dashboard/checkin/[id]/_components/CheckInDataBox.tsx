...
import CheckInConsents from './CheckInConsents';

export default function CheckInDataBox(props: CheckInDataBoxProps) {
  const { booking, optionalBreakfastPrice } = props;
  const {
    created_at,
    startDate,
    endDate,
  ...
  return (
    <div className={'space-y-8'}>
      <div className={'bg-grey-0 dark:bg-grey-700 space-y-8 rounded-lg'}>
        <div
          className={
